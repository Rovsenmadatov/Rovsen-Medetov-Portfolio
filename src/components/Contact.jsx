const socialLinks = [
    ...
    },
    {
      ...
      icon: <svg width="24" height="24"  className="fill-current" fill="#ffffff" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
    ...
    <section className="section" id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className="flex itesm-center gap-2 mt-auto">
            ...
            <form 
            action="https://getform.io/f/ajjjdeva"
            method="POST"
            ...
            >
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" className="text-field " name="name" id="name" autoComplete="name" required placeholder="Rovsen Medetov" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" className="text-field " name="email" id="email" autoComplete="email" required placeholder="yourmail@gmail.com" />
                    </div>
                </div>
